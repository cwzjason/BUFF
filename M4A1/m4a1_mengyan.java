...
public class m4a1_mengyan extends Application {
    ...
    public void start(Stage primaryStage) throws Exception {
    	...
    	button.setOnAction(e -> {
      	...
      	ImageView imageView = new ImageView("image/m4a1_nightmare2.jpg");
      	imageView.setFitHeight(300);
    	imageView.setFitWidth(300);
    	imageView.setX(0);
    	imageView.setY(40);
    	
    	Text text1 = new Text("M4A1-S | Nightmare");
    	...
    	description.setText("Description:\r\nThe M4A1-S has a smaller magazine, quieter sound, less recoil,\r\nand higher accuracy compared to its non-suppressed counterpart.\r\nThe pattern depicts a terrifying night visitor. Set your alarm.");
    	...
    	button1.setOnAction(e -> QuickBuyHelper.show(primaryStage, "M4A1-Nightmare", 38));
