...
public class m4a1_yinhuaji extends Application {
    ...
    public void start(Stage primaryStage) throws Exception {
    	...
    	button.setOnAction(e -> {
      	...
      	ImageView imageView = new ImageView("image/m4a1_printstream2.jpg");
      	imageView.setFitHeight(300);
    	imageView.setFitWidth(300);
    	imageView.setX(0);
    	imageView.setY(40);
    	
    	Text text1 = new Text("M4A1-S | Printstream");
    	...
    	description.setText("Description:\r\nThe silenced M4A1 has a smaller magazine than its\r\nunsilenced counterpart, a quieter shot, lower\r\nrecoil, and better accuracy. This weapon features\r\na custom paint job with a striking black-and-white\r\ndesign, finished with a pearlescent highlight.");
    	...
    	button1.setOnAction(e -> QuickBuyHelper.show(primaryStage, "M4A1-Printstream", 432));
