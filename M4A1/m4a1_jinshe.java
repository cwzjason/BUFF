...
public class m4a1_jinshe extends Application {
    ...
    public void start(Stage primaryStage) throws Exception {
    	...
    	button.setOnAction(e -> {
      	...
      	ImageView imageView = new ImageView("image/m4a1_golden_serpent2.jpg");
      	imageView.setFitHeight(300);
    	imageView.setFitWidth(300);
    	imageView.setX(0);
    	imageView.setY(40);
    	
    	Text text1 = new Text("M4A1-S | Golden Coil");
    	...
    	button1.setOnAction(e -> QuickBuyHelper.show(primaryStage, "M4A1-Golden Coil", 180));
