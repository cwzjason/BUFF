...
public class m4a1_huimiezhe extends Application {
    ...
    public void start(Stage primaryStage) throws Exception {
    	...
    	button.setOnAction(e -> {
      	...
      	ImageView imageView = new ImageView("image/m4a1_destroyer20002.jpg");
      	imageView.setFitHeight(300);
    	imageView.setFitWidth(300);
    	imageView.setX(0);
    	imageView.setY(40);
    	
    	Text text1 = new Text("M4A1-S | Destroyer 2000");
    	...
    	button1.setOnAction(e -> QuickBuyHelper.show(primaryStage, "M4A1-Destroyer 2000", 27));
