...
public class hot_topics extends main{
...
launch(args);
	...
	public void start(Stage primaryStage) throws Exception {
        ...
        ImageView imageView1 = new ImageView("image/ak47_fire_serpent2.jpg");
        ...
        ImageView imageView3 = new ImageView("image/karambit_legend2.jpg");
    	...
    	imageView4.setOnMouseClicked(e -> {
    		boolean success = false;
				hdd_jianbian open = new hdd_jianbian();
			try {
				open.start(new Stage());
				success = true;
			} catch (Exception e1) {
        ...
        imageView5.setOnMouseClicked(e -> {
        	boolean success = false;
				m9_duopule open = new m9_duopule();
			try {
				open.start(new Stage());
				success = true;
			} catch (Exception e1) {
        ...
        ImageView imageView7 = new ImageView("image/m9_marble_fade2.jpg");
        ...
        ImageView imageView8 = new ImageView("image/sport_fade2.jpg");
    	...
    	pane.getChildren().addAll(button,name1,imageView1,name2,imageView2,price2,price1,name3,imageView3,price3,name4,imageView4,price4,name5,imageView5,price5,name6,imageView6,price6,name7,imageView7,price7,name8,imageView8,price8);
