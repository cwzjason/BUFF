...
public class zy_tegong extends Application {
    ...
    public void start(Stage primaryStage) throws Exception {
    	...
    	button.setOnAction(e -> {
      	...
      	ImageView imageView = new ImageView("image/sport_field_agent2.jpg");
      	imageView.setFitHeight(300);
    	imageView.setFitWidth(300);
    	imageView.setX(0);
    	imageView.setY(40);
    	
    	Text text1 = new Text("Specialist Gloves | Field Agent");
    	...
    	description.setText("Description:\r\nDurable, breathable, and stylish; these gloves are specifically designed to withstand (and deliver) punishment.");
    	...
    	button1.setOnAction(e -> QuickBuyHelper.show(primaryStage, "SpecGloves-Field Agent", 990));
