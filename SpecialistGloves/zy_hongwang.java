...
public class zy_hongwang extends Application {
    ...
    public void start(Stage primaryStage) throws Exception {
    	...
    	button.setOnAction(e -> {
      	...
      	ImageView imageView = new ImageView("image/sport_crimson_web2.jpg");
      	imageView.setFitHeight(300);
    	imageView.setFitWidth(300);
    	imageView.setX(0);
    	imageView.setY(40);
    	
    	Text text1 = new Text("Specialist Gloves | Crimson Web");
    	...
    	button1.setOnAction(e -> QuickBuyHelper.show(primaryStage, "SpecGloves-Crimson Web", 3821));
