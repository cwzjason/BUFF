...
public class zy_laohu extends Application {
    ...
    public void start(Stage primaryStage) throws Exception {
    	...
    	button.setOnAction(e -> {
      	...
      	ImageView imageView = new ImageView("image/sport_tiger_elite2.jpg");
      	imageView.setFitHeight(300);
    	imageView.setFitWidth(300);
    	imageView.setX(0);
    	imageView.setY(40);
    	
    	Text text1 = new Text("Specialist Gloves | Tiger Tooth");
    	...
    	button1.setOnAction(e -> QuickBuyHelper.show(primaryStage, "SpecGloves-Tiger Tooth", 1729));
