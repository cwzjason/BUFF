...
public class yd_shuangxi extends Application {
    ...
    public void start(Stage primaryStage) throws Exception {
    	...
    	button.setOnAction(e -> {
      	...
      	ImageView imageView = new ImageView("image/specialist_amphibious2.jpg");
      	imageView.setFitHeight(300);
    	imageView.setFitWidth(300);
    	imageView.setX(0);
    	imageView.setY(40);
    	
    	Text text1 = new Text("Sport Gloves | Amphibious");
    	...
    	button1.setOnAction(e -> QuickBuyHelper.show(primaryStage, "SportGloves-Amphibious", 2391));
