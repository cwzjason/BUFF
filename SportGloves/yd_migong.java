...
public class yd_migong extends Application {
    ...
    public void start(Stage primaryStage) throws Exception {
    	...
    	button.setOnAction(e -> {
      	...
      	ImageView imageView = new ImageView("image/specialist_hedge_maze2.jpg");
      	imageView.setFitHeight(300);
    	imageView.setFitWidth(300);
    	imageView.setX(0);
    	imageView.setY(40);
    	
    	Text text1 = new Text("Sport Gloves | Hedge Maze");
    	...
    	description.setText("Description:\r\nThe synthetic fabric makes these sport gloves durable and eye-catching.\r\nThese green and white gloves are made by the Icaros Athletic Association.\r\nOnly cowards fear flying too close to the sun.");
    	...
    	button1.setOnAction(e -> QuickBuyHelper.show(primaryStage, "SportGloves-Hedge Maze", 8209));
