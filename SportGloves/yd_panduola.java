...
public class yd_panduola extends Application {
    ...
    public void start(Stage primaryStage) throws Exception {
    	...
    	button.setOnAction(e -> {
      	...
      	ImageView imageView = new ImageView("image/specialist_pandoras_box2.jpg");
      	imageView.setFitHeight(300);
    	imageView.setFitWidth(300);
    	imageView.setX(0);
    	imageView.setY(40);
    	
    	Text text1 = new Text("Sport Gloves | Pandora's Box");
    	...
    	description.setText("Description:\r\nThe synthetic fabric makes these sport gloves durable and eye-catching.\r\nThese black and violet gloves feature subtle palm patterns. Essential for sweat experts.");
    	...
    	button1.setOnAction(e -> QuickBuyHelper.show(primaryStage, "SportGloves-Pandora Box", 12204));
