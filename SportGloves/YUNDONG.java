...
public class YUNDONG extends main{
...
launch(args);
	...
	public void start(Stage primaryStage) throws Exception {
    	...
    	ImageView imageView2 = new ImageView("image/specialist_hedge_maze1.jpg");
        ...
        imageView3.setOnMouseClicked(e -> {
        	boolean success = false;
				yd_chaodaoti open = new yd_chaodaoti();
			try {
				open.start(new Stage());
				success = true;
			} catch (Exception e1) {
    	...
    	imageView4.setOnMouseClicked(e -> {
    		boolean success = false;
				yd_panduola open = new yd_panduola();
			try {
				open.start(new Stage());
				success = true;
			} catch (Exception e1) {
        ...
        imageView5.setOnMouseClicked(e -> {
        	boolean success = false;
				yd_shuangxi open = new yd_shuangxi();
			try {
				open.start(new Stage());
				success = true;
			} catch (Exception e1) {
    	...
    	Text name5 = new Text("Sport Gloves | Amphibious");
    	name5.setFont(Font.font(null, FontWeight.BOLD,10));
    	name5.setLayoutX(0);
    	name5.setLayoutY(400);
    	Text price5 = new Text("$ 2391");
