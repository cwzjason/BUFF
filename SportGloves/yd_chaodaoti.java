...
public class yd_chaodaoti extends Application {
    ...
    public void start(Stage primaryStage) throws Exception {
    	...
    	button.setOnAction(e -> {
      	...
      	ImageView imageView = new ImageView("image/specialist_superconductor2.jpg");
      	imageView.setFitHeight(300);
    	imageView.setFitWidth(300);
    	imageView.setX(0);
    	imageView.setY(40);
    	
    	Text text1 = new Text("Sport Gloves | Superconductor");
    	...
    	description.setText("Description:\r\nThe synthetic fabric makes these sport gloves durable and eye-catching.\r\nThese blue-black gloves are ideal for those seeking instant fame. They refuse to leave empty-handed.");
    	...
    	button1.setOnAction(e -> QuickBuyHelper.show(primaryStage, "SportGloves-Superconductor", 5506));
