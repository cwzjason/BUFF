...
public class yd_dangong extends Application {
    ...
    public void start(Stage primaryStage) throws Exception {
    	...
    	button.setOnAction(e -> {
      	...
      	ImageView imageView = new ImageView("image/specialist_slingshot2.jpg");
      	imageView.setFitHeight(300);
    	imageView.setFitWidth(300);
    	imageView.setX(0);
    	imageView.setY(40);
    	
    	Text text1 = new Text("Sport Gloves | Slingshot");
    	...
    	button1.setOnAction(e -> QuickBuyHelper.show(primaryStage, "SportGloves-Slingshot", 3358));
