...
public class ak_nihong extends Application {
    ...
    public void start(Stage primaryStage) throws Exception {
    	...
    	button.setOnAction(e -> {
      	...
      	ImageView imageView = new ImageView("image/ak47_neon_rider2.jpg");
      	imageView.setFitHeight(300);
    	imageView.setFitWidth(300);
    	imageView.setX(0);
    	imageView.setY(40);
    	
    	Text text1 = new Text("AK-47 | Neon Rider");
    	...
    	button1.setOnAction(e -> QuickBuyHelper.show(primaryStage, "AK47-Neon Rider", 132));
