...
public class ak_erxi extends Application {
    ...
    public void start(Stage primaryStage) throws Exception {
    	...
    	button.setOnAction(e -> {
      	...
      	ImageView imageView = new ImageView("image/ak47_asiimov2.jpg");
      	imageView.setFitHeight(300);
    	imageView.setFitWidth(300);
    	imageView.setX(0);
    	imageView.setY(40);
    	
    	Text text1 = new Text("AK-47 | Asiimov");
    	...
    	button1.setOnAction(e -> QuickBuyHelper.show(primaryStage, "AK47-Asiimov", 210));
