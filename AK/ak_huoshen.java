...
public class ak_huoshen extends Application {
    ...
    public void start(Stage primaryStage) throws Exception {
    	...
    	button.setOnAction(e -> {
      	...
      	ImageView imageView = new ImageView("image/ak47_vulcan2.jpg");
      	imageView.setFitHeight(300);
    	imageView.setFitWidth(300);
    	imageView.setX(0);
    	imageView.setY(40);
    	
    	Text text1 = new Text("AK-47 | Vulcan");
    	...
    	button1.setOnAction(e -> QuickBuyHelper.show(primaryStage, "AK47-Vulcan", 900));
