...
public class ak_huoshe extends Application {
    ...
    public void start(Stage primaryStage) throws Exception {
    	...
    	button.setOnAction(e -> {
      	...
      	ImageView imageView = new ImageView("image/ak47_fire_serpent2.jpg");
      	imageView.setFitHeight(300);
    	imageView.setFitWidth(300);
    	imageView.setX(0);
    	imageView.setY(40);
    	
    	Text text1 = new Text("AK-47 | Fire Serpent");
    	...
    	description.setText("Description:\r\n\r\nPowerful and reliable, the AK-47 is one of the most\r\npopular assault rifles in the world. Deadly in short,\r\ncontrolled bursts. This commemorative weapon from\r\nancient Maya ruins has been painted with a fire\r\nserpent motif. Don't want to end up dead on the\r\nstreet? Learn to breathe fire.");
    	...
    	button1.setOnAction(e -> QuickBuyHelper.show(primaryStage, "AK47-Fire Serpent", 2859));
