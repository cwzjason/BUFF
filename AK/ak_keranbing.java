...
public class ak_keranbing extends Application {
    ...
    public void start(Stage primaryStage) throws Exception {
    	...
    	button.setOnAction(e -> {
      	...
      	ImageView imageView = new ImageView("image/ak47_combustible_ice2.jpg");
      	imageView.setFitHeight(300);
    	imageView.setFitWidth(300);
    	imageView.setX(0);
    	imageView.setY(40);
    	
    	Text text1 = new Text("AK-47 | Combustible Ice");
    	...
    	button1.setOnAction(e -> QuickBuyHelper.show(primaryStage, "AK47-Combustible Ice", 37));
