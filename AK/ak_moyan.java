...
public class ak_moyan extends Application {
    ...
    public void start(Stage primaryStage) throws Exception {
    	...
    	button.setOnAction(e -> {
      	...
      	ImageView imageView = new ImageView("image/ak47_dark_rock2.jpg");
      	imageView.setFitHeight(300);
    	imageView.setFitWidth(300);
    	imageView.setX(0);
    	imageView.setY(40);
    	
    	Text text1 = new Text("AK-47 | Dark Rock");
    	...
    	button1.setOnAction(e -> QuickBuyHelper.show(primaryStage, "AK47-Dark Rock", 9));
