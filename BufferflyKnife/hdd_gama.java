...
public class hdd_gama extends Application {
    ...
    public void start(Stage primaryStage) throws Exception {
    	...
    	button.setOnAction(e -> {
      	...
      	ImageView imageView = new ImageView("image/butterfly_gamma_doppler2.jpg");
      	imageView.setFitHeight(300);
    	imageView.setFitWidth(300);
    	imageView.setX(0);
    	imageView.setY(40);
    	
    	Text text1 = new Text("Butterfly Knife (StatTrak) | Gamma Doppler");
    	...
    	description.setText("Description:\r\n\r\nA specially designed flip knife, commonly known as a butterfly.\r\nThe most distinctive feature is its fan-like freely swinging blade.\r\nThis weapon features black and silver metallic paint with faux marble\r\npattern, disguising its deadly nature.");
    	...
    	button1.setOnAction(e -> QuickBuyHelper.show(primaryStage, "Butterfly-Gamma Doppler", 18081));
