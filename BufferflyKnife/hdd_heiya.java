...
public class hdd_heiya extends Application {
    ...
    public void start(Stage primaryStage) throws Exception {
    	...
    	button.setOnAction(e -> {
      	...
      	ImageView imageView = new ImageView("image/butterfly_black_laminate2.png");
      	imageView.setFitHeight(300);
    	imageView.setFitWidth(300);
    	imageView.setX(0);
    	imageView.setY(40);
    	
    	Text text1 = new Text("Butterfly Knife (StatTrak) | Black Laminate");
    	...
    	button1.setOnAction(e -> QuickBuyHelper.show(primaryStage, "Butterfly-Black Laminate", 1728));
