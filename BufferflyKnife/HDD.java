...
launch(args);
	...
	public void start(Stage primaryStage) throws Exception {
        ...
        ImageView imageView1 = new ImageView("image/butterfly_black_laminate1.png");
    	...
    	Text name5 = new Text("Butterfly Knife | Slaughter");
    	name5.setFont(Font.font(null, FontWeight.BOLD,10));
    	name5.setLayoutX(0);
    	name5.setLayoutY(400);
    	Text price5 = new Text("$ 1765");
