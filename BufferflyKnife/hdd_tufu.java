...
public class hdd_tufu extends Application {
    ...
    public void start(Stage primaryStage) throws Exception {
    	...
    	button.setOnAction(e -> {
      	...
      	ImageView imageView = new ImageView("image/butterfly_slaughter2.jpg");
      	imageView.setFitHeight(300);
    	imageView.setFitWidth(300);
    	imageView.setX(0);
    	imageView.setY(40);
    	
    	Text text1 = new Text("Butterfly Knife (StatTrak) | Butcher");
    	...
    	button1.setOnAction(e -> QuickBuyHelper.show(primaryStage, "Butterfly-Butcher", 1765));
