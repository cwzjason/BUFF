...
public class hdd_ziyou extends Application {
    ...
    public void start(Stage primaryStage) throws Exception {
    	...
    	button.setOnAction(e -> {
      	...
      	ImageView imageView = new ImageView("image/butterfly_freehand2.jpg");
      	imageView.setFitHeight(300);
    	imageView.setFitWidth(300);
    	imageView.setX(0);
    	imageView.setY(40);
    	
    	Text text1 = new Text("Butterfly Knife (StatTrak) | Free Hand");
    	...
    	button1.setOnAction(e -> QuickBuyHelper.show(primaryStage, "Butterfly-Free Hand", 1261));
