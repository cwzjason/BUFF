...
public class awp_long extends Application {
    ...
    public void start(Stage primaryStage) throws Exception {
    	...
    	button.setOnAction(e -> {
      	...
      	ImageView imageView = new ImageView("image/awp_dragon_lore2.jpg");
      	imageView.setFitHeight(300);
    	imageView.setFitWidth(300);
    	imageView.setX(0);
    	imageView.setY(40);
    	
    	Text text1 = new Text("AWP (StatTrak) | Dragon Lore");
    	...
    	button1.setOnAction(e -> QuickBuyHelper.show(primaryStage, "AWP-Dragon Lore", 12581));
