...
public class awp_jinfensihe extends Application {
    ...
    public void start(Stage primaryStage) throws Exception {
    	...
    	button.setOnAction(e -> {
      	...
      	ImageView imageView = new ImageView("image/awp_golden_serpent2.jpg");
      	imageView.setFitHeight(300);
    	imageView.setFitWidth(300);
    	imageView.setX(0);
    	imageView.setY(40);
    	
    	Text text1 = new Text("AWP | Golden Serpent");
    	...
    	description.setText("Description:\r\n\r\nHigh risk, high reward, the infamous AWP is known\r\nfor its iconic gunshot and one-shot-one-kill\r\npolicy. This weapon features a custom paint job\r\nwith a snake on each side - one red, one gold.\r\nA river has two banks. Everything has two sides.");
    	...
    	button1.setOnAction(e -> QuickBuyHelper.show(primaryStage, "AWP-Golden Serpent", 39));
