...
public class awp_jiutoujinshe extends Application {
    ...
    public void start(Stage primaryStage) throws Exception {
    	...
    	button.setOnAction(e -> {
      	...
      	ImageView imageView = new ImageView("image/awp_hydra2.jpg");
      	imageView.setFitHeight(300);
    	imageView.setFitWidth(300);
    	imageView.setX(0);
    	imageView.setY(40);
    	
    	Text text1 = new Text("AWP | Hydra");
    	...
    	description.setText("Description:\r\n\r\nHigh risk, high reward, the infamous AWP is known\r\nfor its iconic gunshot and one-shot-one-kill\r\npolicy. This AWP features a custom paint job, with\r\na golden snake painted on the barrel. The scope,\r\nbarrel, and stock are painted white.");
    	...
    	button1.setOnAction(e -> QuickBuyHelper.show(primaryStage, "AWP-Hydra", 3354));
