...
public class awp_meiying extends Application {
    ...
    public void start(Stage primaryStage) throws Exception {
    	...
    	button.setOnAction(e -> {
      	...
      	ImageView imageView = new ImageView("image/awp_black_phantom2.jpg");
      	imageView.setFitHeight(300);
    	imageView.setFitWidth(300);
    	imageView.setX(0);
    	imageView.setY(40);
    	
    	Text text1 = new Text("AWP (StatTrak) | Black Laminate");
    	...
    	description.setText("Description:\r\n\r\nHigh risk, high reward - the infamous AWP is known for its\r\nsignature sound and one-shot, one-kill policy. This weapon features a\r\ncustom paint job with a grayscale background accented in blue and\r\nmagenta, depicting two women of unique charm.");
		...
		button1.setOnAction(e -> QuickBuyHelper.show(primaryStage, "AWP-Black Laminate", 39));
