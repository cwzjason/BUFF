...
public class m9_ziluolan extends Application {
    ...
    public void start(Stage primaryStage) throws Exception {
    	...
    	button.setOnAction(e -> {
      	...
      	ImageView imageView = new ImageView("image/m9_violet2.jpg");
      	imageView.setFitHeight(300);
    	imageView.setFitWidth(300);
    	imageView.setX(0);
    	imageView.setY(40);
    	
    	Text text1 = new Text("M9 Bayonet | Lethal Violet");
    	...
    	description.setText("Description:\r\nThis is an M9 Bayonet. Originally mounted on a rifle,\r\nit is also excellent for close-quarters combat.\r\nSome components are spray-painted in a black and violet scheme.\r\nBeneath its noble pattern lies a sinister conspiracy.");
    	...
    	button1.setOnAction(e -> QuickBuyHelper.show(primaryStage, "M9-Lethal Violet", 1412));
