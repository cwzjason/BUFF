...
public class m9_huya extends Application {
    ...
    public void start(Stage primaryStage) throws Exception {
    	...
    	button.setOnAction(e -> {
      	...
      	ImageView imageView = new ImageView("image/m9_tiger_tooth2.jpg");
      	imageView.setFitHeight(300);
    	imageView.setFitWidth(300);
    	imageView.setX(0);
    	imageView.setY(40);
    	
    	Text text1 = new Text("M9 Bayonet | Tiger Tooth");
    	...
    	description.setText("Description:\r\nThe M-9 Bayonet. Originally designed to be mounted\r\non a rifle, it is also well-suited for close-quarters\r\ncombat. This weapon features a tiger-stripe pattern\r\nwith an orange-gold electroplated finish and hand\r\netching. As rare as a tiger... as deadly as a tiger...");
    	...
    	button1.setOnAction(e -> QuickBuyHelper.show(primaryStage, "M9 Bayonet-Tiger Tooth", 1258));
