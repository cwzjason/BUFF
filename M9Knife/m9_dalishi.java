...
public class m9_dalishi extends Application {
    ...
    public void start(Stage primaryStage) throws Exception {
    	...
    	button.setOnAction(e -> {
      	...
      	ImageView imageView = new ImageView("image/m9_marble_fade2.jpg");
      	imageView.setFitHeight(300);
    	imageView.setFitWidth(300);
    	imageView.setX(0);
    	imageView.setY(40);
    	
    	Text text1 = new Text("M9 Bayonet | Marble Fade");
    	...
    	description.setText("Description:\r\nThe M-9 Bayonet. Originally designed to be mounted\r\non a rifle, it is also well-suited for close-quarters\r\ncombat. This weapon has been painted with a faux-\r\nmarble finish using black and silver metallic paint,\r\ncoated with three layers of candy finish.\r\nWhere blade meets rainbow, meets blood.");
    	...
    	button1.setOnAction(e -> QuickBuyHelper.show(primaryStage, "M9 Bayonet-Marble Fade", 1695));
