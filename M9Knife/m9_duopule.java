...
public class m9_duopule extends Application {
    ...
    public void start(Stage primaryStage) throws Exception {
    	...
    	button.setOnAction(e -> {
      	...
      	ImageView imageView = new ImageView("image/m9_doppler2.jpg");
      	imageView.setFitHeight(300);
    	imageView.setFitWidth(300);
    	imageView.setX(0);
    	imageView.setY(40);
    	
    	Text text1 = new Text("M9 Bayonet | Doppler");
    	...
    	description.setText("Description:\r\nThis is an M9 Bayonet. Originally mounted on a rifle,\r\nit is also excellent for close-quarters combat.\r\nThis weapon features faux marble pattern paint in black and silver,\r\nwith a sugary coating. Don't be fooled by its appearance -\r\nthe consequences can be severe.");
    	...
    	button1.setOnAction(e -> QuickBuyHelper.show(primaryStage, "M9-Doppler", 15962));
