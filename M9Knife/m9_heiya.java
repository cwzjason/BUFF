...
public class m9_heiya extends Application {
    ...
    public void start(Stage primaryStage) throws Exception {
    	...
    	button.setOnAction(e -> {
      	...
      	ImageView imageView = new ImageView("image/m9_black_laminate2.jpg");
      	imageView.setFitHeight(300);
    	imageView.setFitWidth(300);
    	imageView.setX(0);
    	imageView.setY(40);
    	
    	Text text1 = new Text("M9 Bayonet | Black Laminate");
    	...
    	button1.setOnAction(e -> QuickBuyHelper.show(primaryStage, "M9-Black Laminate", 1139));
