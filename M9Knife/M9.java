...
launch(args);
	...
	public void start(Stage primaryStage) throws Exception {
        ...
        ImageView imageView1 = new ImageView("image/m9_doppler1.jpg");
    	...
    	Text name5 = new Text("M9 Bayonet | Black Laminate");
    	name5.setFont(Font.font(null, FontWeight.BOLD,10));
    	name5.setLayoutX(0);
    	name5.setLayoutY(400);
    	Text price5 = new Text("$ 1139");
