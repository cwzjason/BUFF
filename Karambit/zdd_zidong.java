...
public class zdd_zidong extends Application {
    ...
    public void start(Stage primaryStage) throws Exception {
    	...
    	button.setOnAction(e -> {
      	...
      	ImageView imageView = new ImageView("image/karambit_autotronic2.jpg");
      	imageView.setFitHeight(300);
    	imageView.setFitWidth(300);
    	imageView.setX(0);
    	imageView.setY(40);
    	
    	Text text1 = new Text("Karambit | Autotronic");
    	...
    	description.setText("Description:\r\nWith its curved blade resembling a tiger's claw, the Karambit was\r\ndeveloped as part of Malay martial arts. This weapon has been anodized red and uses a precision steel mesh to reduce weight.");
    	...
    	button1.setOnAction(e -> QuickBuyHelper.show(primaryStage, "Karambit-Autotronic", 2239));
