...
public class zzd_hongwang extends Application {
    ...
    public void start(Stage primaryStage) throws Exception {
    	...
    	button.setOnAction(e -> {
      	...
      	ImageView imageView = new ImageView("image/karambit_crimson_web2.jpg");
      	imageView.setFitHeight(300);
    	imageView.setFitWidth(300);
    	imageView.setX(0);
    	imageView.setY(40);
    	
    	Text text1 = new Text("Karambit | Crimson Web");
    	...
    	description.setText("Description:\r\nWith its curved blade resembling a tiger\u2019s claw,\r\nthe Karambit was developed as part of the Malay\r\nmartial arts. This weapon features a red exterior\r\nwith a spider web pattern finish, completed with a\r\nsemi-gloss surface. Watch your step, you never know\r\nwhere the web has been spun.");
    	...
    	button1.setOnAction(e -> QuickBuyHelper.show(primaryStage, "Karambit-Crimson Web", 1439));
