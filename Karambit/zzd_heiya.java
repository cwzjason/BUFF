...
public class zzd_heiya extends Application {
    ...
    public void start(Stage primaryStage) throws Exception {
    	...
    	button.setOnAction(e -> {
      	...
      	ImageView imageView = new ImageView("image/karambit_black_laminate2.jpg");
      	imageView.setFitHeight(300);
    	imageView.setFitWidth(300);
    	imageView.setX(0);
    	imageView.setY(40);
    	
    	Text text1 = new Text("Karambit | Black Laminate");
    	...
    	description.setText("Description:\r\nWith its curved blade resembling a tiger's claw, the Karambit was\r\ndeveloped as part of Malay martial arts. This dagger is typically held in a reverse grip.\r\nThe weapon has a matte finish with black laminate grips.");
    	...
    	button1.setOnAction(e -> QuickBuyHelper.show(primaryStage, "Karambit-Black Laminate", 1370));
