...
public class zzd_chuanshuo extends Application {
    ...
    public void start(Stage primaryStage) throws Exception {
    	...
    	button.setOnAction(e -> {
      	...
      	ImageView imageView = new ImageView("image/karambit_legend2.jpg");
      	imageView.setFitHeight(300);
    	imageView.setFitWidth(300);
    	imageView.setX(0);
    	imageView.setY(40);
    	
    	Text text1 = new Text("Karambit | Legend");
    	...
    	description.setText("Description:\r\nWith its curved blade resembling a tiger\u2019s claw,\r\nthe Karambit was developed as part of the Malay\r\nmartial arts. This knife is typically held with the\r\nindex and ring finger in a reverse grip. This weapon\r\nfeatures a custom paint job with a rope knot design.");
    	...
    	button1.setOnAction(e -> QuickBuyHelper.show(primaryStage, "Karambit-Legend", 3065));
