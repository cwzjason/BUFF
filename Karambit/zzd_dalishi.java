...
public class zzd_dalishi extends Application {
    ...
    public void start(Stage primaryStage) throws Exception {
    	...
    	button.setOnAction(e -> {
      	...
      	ImageView imageView = new ImageView("image/karambit_marble_fade2.jpg");
      	imageView.setFitHeight(300);
    	imageView.setFitWidth(300);
    	imageView.setX(0);
    	imageView.setY(40);
    	
    	Text text1 = new Text("Karambit | Marble Fade");
    	...
    	description.setText("Description:\r\nWith its curved blade resembling a tiger\u2019s claw,\r\nthe Karambit was developed as part of the Malay\r\nmartial arts. This weapon has been painted with a\r\nfaux-marble finish using black and silver metallic\r\npaint, coated with three layers of candy finish.\r\nWhere blade meets rainbow, meets blood.");
    	...
    	button1.setOnAction(e -> QuickBuyHelper.show(primaryStage, "Karambit-Marble Fade", 1777));
